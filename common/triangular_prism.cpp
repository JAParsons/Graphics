...
/*make a tri prism from hard-coded vertex positions and normals  */
void TriPrism::makeTriPrism()
{
	...
	/*create the normals  buffer for the prims */
...
void TriPrism::drawTriPrism(int drawmode)
{
